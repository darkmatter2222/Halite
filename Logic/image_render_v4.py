...
class image_render_v4():
    ...
    def initialize_sprite_models(self):
        ...
        error_model = np.zeros([sprite_size, sprite_size])
        ...
        self._sprite_models['error_sprite'] = error_model
        ...
        # paint error
        render_error_sprite = np.zeros([sprite_size, sprite_size, 3])
        for h in range(sprite_size):
            for w in range(sprite_size):
                if self._sprite_models['error_sprite'][h, w] == 1:
                    render_error_sprite[h, w] = [255, 255, 255]
                else:
                    render_error_sprite[h, w] = [0, 0, 0]  # heatmap background

        self._premade_rendered_sprites[f'error_sprite'] = render_error_sprite
            ...
            for board_w in range(self._board_size):
                ...
                try:
                    ...
                    if board_cell.shipyard is not None and board_cell.ship is not None:
                        ...
                        board_x * sprite_size:board_x * sprite_size + sprite_size] = \
                            self._premade_rendered_sprites[
                                f'ship_and_shipyard_sprite_player_{board_cell.shipyard._player_id}']
                    ...
                    master_image[board_h * sprite_size:board_h * sprite_size + sprite_size,
                    board_x * sprite_size:board_x * sprite_size + sprite_size] = \
                        self._premade_rendered_sprites[f'error_sprite']
